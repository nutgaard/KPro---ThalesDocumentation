...
This Chapter will cover the preliminary studies carried out in this project and will provide an understanding of the problem to be solved, what solutions exist already and what solutions we have chosen.
...
The messages that a user sends should support certain military attributes, these include precedence, type and security label. Precedence indicates the level of urgency, and type indicates the type of the message. Security label on the other hand says something about the receiver of the message, and not the message itself. The security label states what security clearance the receiver must have to be able to open the message.
\newline
\newline
...
Another message functionality is the ability to send instant messages with predefined military attributes to a predefined receiver. The receiver can be a group or a single person. These can include predefined text or information from another application. It should also be possible to send messages with content that is created by other applications on the device.
\newline
\newline
