...
Java is a class based, object oriented language that incorporates concurrency and is a general purpose language. %The main reason Java was developed, was to create a programming language which had a simpler object model and provided fewer low-level facilities than C or C++. Even though, much of its syntax is derived from these languages.\cite{bib:java}
