...
\newline
\newline
We also made some important decisions about the application. The first choice was to have the service running in the same process as the application instead of in a separate process.%, since Android supports both services easily.
\newline
\newline
