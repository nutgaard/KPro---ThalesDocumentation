...
\item{}\textbf{Filter traffic:} find out how to filter out traffic from only our app. This can be done by a combination of Mac-address, port number and content of data sent (if possible).
