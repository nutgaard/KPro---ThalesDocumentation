...
\begin{itemize}
\item{}\textbf{Implement threaded SMTP queue:}
\item{}\textbf{Implement stripping of message based on network connection:}
\item{}\textbf{Implement usage IMAP specific attributes:}
\item{}\textbf{Save messages downloaded from server:}
\item{}\textbf{Update message IMAP message status:}
\item{}\textbf{Implement pull strategy:}
\item{}\textbf{Implement push strategy:}
\item{}\textbf{Implement handling for pre-send processing of messages:}
\item{}\textbf{Implement handling for control-messages:}
\end{itemize}
...
\begin{itemize}
\item{}\textbf{Implement a keystore for saving and loading trusted keys:}
\item{}\textbf{SPIKE: bouncycastle for android :}
\item{}\textbf{Implement S/MIME signing of messages:}
\item{}\textbf{Implement verification of signing messages:}
\end{itemize}
...
\begin{itemize}
\item{}\textbf{Delete from local storage:}
\item{}\textbf{Delete from mail server:}
\item{}\textbf{Update GUI:}
\end{itemize}
