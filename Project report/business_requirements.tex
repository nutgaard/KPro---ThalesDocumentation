...
Stimulus & Wants to access data saved by our application \\
Artifact & System \\
Environment & Under normal operations \\
Response & User is blocked from accessing data by the Android OS. \\
Response measure & No data exposed to the user or application. \\ \hline
\end{tabularx}
\end{center}
...
See table \ref{tab:functionalreq} on page \pageref{tab:functionalreq}.
...
\item{}Choose which security labels should be visible in the New Message window; Allowing, for example, a local Norwegian operation to ignore NATO security labels.
...
See table \ref{tab:stakeholders} on page \pageref{tab:stakeholders}.
...
\item{} Installation should be easy, just download the application from Android market, and it’s ready to use.
