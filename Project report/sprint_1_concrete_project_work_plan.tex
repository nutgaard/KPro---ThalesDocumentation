...
\textbf{Milestone:} Have a working demo to show the customer and adviser that is able to send and receive messages, as well as open old messages. We want to have a \gls{gui} that is functional but not necessarily pretty or finalized.
\newline
\newline
