...
%Lagt til av Kristin - topptekst
\usepackage{fancyhdr}
\pagestyle{fancy}
%\fancyhead[CO, CE]{---XOXOmail---}
...
\part{Conclusion \& reflection}
	...
	\include*{conclusion_system_overview}

	\include*{conclusion}

	\include*{conclusion_further_development}
...
\bibitem{bib:XOhome} http://www.xomail.com/dl/xomail-brochure.pdf
...
\bibitem{bib:green} Greenhopper. Retrieved 2012-09-25 from http://www.atlassian.com/software/greenhopper/overview
\bibitem{bib:netbeans} NetBeans. Retrieved 2012-09-25 from http://netbeans.org/features/index.html
\bibitem{bib:eclipse} Eclipse. Retrieved 2012-11-19 from http://en.wikipedia.org/wiki/Eclipse(software)
...
\bibitem{bib:wireshark} Wireshark. Retrieved 2012-11-19 from http://en.wikipedia.org/wiki/Wireshark
\bibitem{bib:tls} Data Transport Layer Security. Retrieved 2012-11-19 from http://en.wikipedia.org/wiki/Transport\_Layer\_Security
...
\bibitem{bib:animationcodec} Animation Codec. Retreived 2012-11-19 from http://en.wikipedia.org/wiki/Animation\_codec
...
\bibitem{bib:cobertura} Cobertura. Retrieved 2012-11-19 from http://cobertura.sourceforge.net/
\bibitem{bib:susavg}SUS avg. Retrieved 2012-11-19 from http://www.measuringusability.com/sus.php
...
\part{Appendices}
	...
	\include{wireshark_results}

	\include{test_cases_appendix}

	\include{usability_tests}
