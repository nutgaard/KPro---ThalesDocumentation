...
\bibitem{bib:contextTreeWeighting} Context Tree Weighting.  Retrieved 2012-11-2 from http://en.wikipedia.org/wiki/Context\_tree\_weighting
\bibitem{bib:contextTreeWeightingResearch} Context Tree Weighting Research. Retrieved 2012-11-2 from http://www.sps.ele.tue.nl/members/F.M.J.Willems/RESEARCH\_files/CTW/ResearchCTW.htm
\bibitem{bib:burrowsWheelerTransform} Burrows Wheeler Transform. Retrieved 2012-11-2 from http://en.wikipedia.org/wiki/Burrows-Wheeler\_transform
\bibitem{bib:LZ77} LZ77. Retrieved 2012-11-2 from http://en.wikipedia.org/wiki/LZ77
\bibitem{bib:GIF} GIF. Retrieved 2012-11-2 from http://no.wikipedia.org/wiki/GIF
\bibitem{bib:gifsicle} GifSicle. Retreived 2012-11-2 from http://www.lcdf.org/gifsicle/
\bibitem{bib:PNG} PNG. Retreived 2012-11-3 from http://no.wikipedia.org/wiki/Portable\_Network\_Graphics
\bibitem{bib:corePNG} corePNG. Retreived 2012-11-3 from http://de.wikipedia.org/wiki/CorePNG
\bibitem{bib:FLAC} FLAC. Retrieved 2012-11-3 from \url 2012-11-3 http://en.wikipedia.org/wiki/MPEG-4\_SLS
\bibitem{bib:MPEGSLS. MPEG-4 SLS} Retrieved 2012-11-3 from http://en.wikipedia.org/wiki/Free\_Lossless\_Audio\_Codec
