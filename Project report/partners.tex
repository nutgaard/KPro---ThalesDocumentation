...
\newline
\newline
See table \ref{tab:projectgroup} on page \pageref{tab:projectgroup}
\begin{table}
...
\newline
\newline
See table \ref{tab:advisor} on page \pageref{tab:advisor}
\begin{table}
...
\newline
\newline
See table \ref{tab:customer} on page \pageref{tab:customer}
\begin{table}
\begin{tabular}{l|l|l|l}
