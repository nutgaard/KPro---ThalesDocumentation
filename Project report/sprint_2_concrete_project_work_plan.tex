...
\textbf{Milestone:} Have a working demo to show Thales and the advisor. In addition to the milestone of sprint 1, it should incorporate an inbox and sent box in a much more comprehensive way where all \gls{gui} functionality is coarsly completed. At completion of the sprint, substantial documentation regarding architecture and security prestudy should also be completed.
See table \ref{tab:sprint2tasks} on page \pageref{tab:sprint2tasks}.
